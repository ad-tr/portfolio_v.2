                ...
                <div className="text-center mb-16 lg:mb-24">
                    ...
                    <div className="flex items-center justify-center gap-8 lg:gap-12">
                        <div className="text-center">
                            ...
                            <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mt-1">Projects</div>
                        </div>
                        <div className="w-px h-8 bg-white/20"></div>
                        <div className="text-center">
                            <div className="text-2xl lg:text-3xl font-bold text-white font-chakra-petch">2024</div>
                            <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mt-1">Latest</div>
                        </div>
                        <div className="w-px h-8 bg-white/20"></div>
                        <div className="text-center">
                            ...
                            <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mt-1">Status</div>
                        </div>
                    </div>
                </div>
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="relative flex-1 flex flex-col p-6 lg:p-8">
                                ...
                                {/* Description */}
                                <p className="font-rajdhani text-sm lg:text-base text-gray-300 font-medium leading-relaxed mb-6 flex-1">
                                    {project.description}
                                </p>
