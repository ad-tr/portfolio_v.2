    ...
    return (
        <nav className="w-full py-6">
            <div className="flex justify-between items-center w-full">
                <Link href="/" className="text-2xl font-bold tracking-tight text-white font-chakra-petch uppercase">
                    TRANCHANT.AI
                </Link>

                <div className="flex items-center space-x-6 font-mono text-xs tracking-widest text-gray-400">
