...
export default function AboutSection() {
    return (
        <section id="about" className="relative w-full min-h-screen bg-black overflow-hidden flex flex-col justify-center py-24 lg:py-40">
            ...
            <div className="container max-w-[2000px] mx-auto px-6 lg:px-20 relative z-10 flex flex-col lg:flex-row items-center">
                ...
                <div className="absolute top-10 left-0 w-full overflow-hidden select-none pointer-events-none opacity-[0.03]">
                    <h2 className="text-[20vw] leading-none font-black text-white whitespace-nowrap -ml-20">
                        ARCHITECT
                    </h2>
                </div>

                {/* 2. LEFT SIDE: Content (Overlapping) */}
                <div className="w-full lg:w-1/2 relative z-20 space-y-12 lg:pr-20">

                    {/* Header */}
                    <div>
                        <div className="flex items-center space-x-3 text-white/50 mb-6 font-mono text-sm tracking-[0.2em] uppercase">
                            <span className="w-8 h-px bg-white/50"></span>
                            <span>Profile Data</span>
                        </div>
                        <h2 className="text-6xl md:text-8xl font-medium tracking-tighter text-white mix-blend-difference">
                            BEYOND <br />
                    ...
                    {/* Bio Text */}
                    <div className="space-y-8 text-lg md:text-xl text-gray-300 font-light leading-relaxed max-w-lg">
                        <p>
                    ...
                    <div className="flex items-center gap-12 pt-8">
                        <div>
                            <span className="block text-4xl font-bold text-white font-chakra-petch">04+</span>
                            <span className="text-xs font-mono text-gray-600 uppercase tracking-widest leading-none">Years Exp.</span>
                        </div>
                        <div className="w-px h-12 bg-white/10"></div>
                        <div>
                            <span className="block text-4xl font-bold text-white font-chakra-petch">25+</span>
                            <span className="text-xs font-mono text-gray-600 uppercase tracking-widest leading-none">Projects</span>
                        </div>
                        <div className="w-px h-12 bg-white/10"></div>
